...
mod tests {
    ...
    fn test_needs_token_refresh_when_expired() {
        ...
        let config = SyncConfig {
            access_token_expires_at: Some(expired_time.to_rfc3339()),
            ..SyncConfig::default()
        };
    ...
    fn test_needs_token_refresh_within_threshold() {
        ...
        let config = SyncConfig {
            access_token_expires_at: Some(soon_expiring.to_rfc3339()),
            ..SyncConfig::default()
        };
    ...
    fn test_no_token_refresh_needed_when_valid() {
        ...
        let config = SyncConfig {
            access_token_expires_at: Some(far_future.to_rfc3339()),
            ..SyncConfig::default()
        };
