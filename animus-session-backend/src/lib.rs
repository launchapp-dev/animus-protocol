...
pub use cli::{
    ...
    CliType, LaunchInvocation,
};
pub use error::{Error, Result};
pub use parser::{extract_text_from_line, NormalizedTextEvent};
pub use session::{
    ClaudeSessionBackend, CodexSessionBackend, GeminiSessionBackend, OaiRunnerSessionBackend, OpenCodeSessionBackend,
    SessionBackend, SessionBackendInfo, SessionBackendKind, SessionBackendResolver, SessionCapabilities, SessionEvent,
    SessionRequest, SessionRun, SessionStability, SubprocessSessionBackend,
};
